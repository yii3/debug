...
/**
 * @var AssetManager $assetManager Yii3 asset manager.
 * @var string $content Rendered shared debugger shell.
 * @var string $theme Resolved debugger theme (`light` or `dark`).
 * @var string $title Document title.
 * @var WebView $this Yii3 web view instance.
 */
$theme ??= 'light';
