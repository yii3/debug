...
final class DebugPageRendererTest extends TestCase
{
    ...
    public function testConfigShowsCapturedInertiaUnderExtensions(): void
    {
        ...
        self::assertSame(
            ...
            <a class="yii-debug-btn yii-debug-btn-ghost yii-debug-btn-icon" href="/debug/view?tag=request-2&amp;panel=config" title="Older request" aria-label="Older captured request">
            ...
            <a class="yii-debug-btn yii-debug-btn-ghost yii-debug-btn-icon" href="/debug/view?tag=request-2&amp;panel=config" title="Oldest request" aria-label="Oldest captured request">
    ...
    public function testConfigShowsExtensionsGroupForIdleInertiaCapture(): void
    {
        $tab = "\t";
    ...
    public function testConfigurationMethodsPreserveExistingSettings(): void
    {
        ...
        $configured = $this
            ->rendererWithPanels(
                'page-renderer-immutability-assets',
                [],
        ...
        self::assertSame(
            ...
            <a class="yii-debug-btn yii-debug-btn-ghost yii-debug-btn-icon" href="/developer/debug/view?tag=request-2&amp;panel=config" title="Older request" aria-label="Older captured request">
            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="m6 9l6 6l6-6"/></g></svg>
            </a>
            <a class="yii-debug-btn yii-debug-btn-ghost yii-debug-btn-icon" href="/developer/debug/view?tag=request-2&amp;panel=config" title="Oldest request" aria-label="Oldest captured request">
            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="m7 7l5 5l5-5"/><path d="m7 13l5 5l5-5"/></g></svg>
            </a>
            </div>
            </div>
            ...
            HTML,
            $html,
            'Panel configuration must retain the configured route prefix.',
        );
    }
    ...
    public function testHistoryAppliesRequestFilters(): void
    {
        ...
        self::assertSame(
            ...
            <form id="yii-debug-history-filters" style="display:none" action="/debug" method="GET"><button type="submit">Submit</button></form><table class="yii-debug-table">
            <thead>
            <tr>
            <th scope="col" class="yii-debug-col-num">#</th>
            <th scope="col" class="yii-debug-col-id"><a href="/debug?Debug%5Bmethod%5D=POST&amp;sort=tag">ID</a></th>
            <th scope="col" aria-sort="descending"><a class="desc" href="/debug?Debug%5Bmethod%5D=POST&amp;sort=time">Time</a></th>
            <th scope="col"><a href="/debug?Debug%5Bmethod%5D=POST&amp;sort=processingTime">Duration</a></th>
            <th scope="col"><a href="/debug?Debug%5Bmethod%5D=POST&amp;sort=peakMemory">Memory</a></th>
            <th scope="col" class="yii-debug-col-ip"><a href="/debug?Debug%5Bmethod%5D=POST&amp;sort=ip">IP</a></th>
            <th scope="col" class="yii-debug-col-num yii-debug-col-mail"><a href="/debug?Debug%5Bmethod%5D=POST&amp;sort=mailCount">Mail</a></th>
            <th scope="col"><a href="/debug?Debug%5Bmethod%5D=POST&amp;sort=method">Method</a></th>
            ...
            <td class="yii-debug-col-num yii-debug-col-mail"><input class="yii-debug-input" name="Debug[mailCount]" type="text" aria-label="Filter by Mail count"></td>
            ...
            <td class="yii-debug-col-num yii-debug-col-mail">0</td>
    ...
    public function testHistoryRendersSummaryFiltersRowsAndNewestRequestSidebar(): void
    {
        ...
        self::assertSame(
            ...
            <tr>
            <th scope="col" class="yii-debug-col-num">#</th>
            <th scope="col" class="yii-debug-col-id"><a href="/debug?sort=tag">ID</a></th>
            <th scope="col" aria-sort="descending"><a class="desc" href="/debug?sort=time">Time</a></th>
            <th scope="col"><a href="/debug?sort=processingTime">Duration</a></th>
            <th scope="col"><a href="/debug?sort=peakMemory">Memory</a></th>
            <th scope="col" class="yii-debug-col-ip"><a href="/debug?sort=ip">IP</a></th>
            <th scope="col" class="yii-debug-col-num yii-debug-col-mail"><a href="/debug?sort=mailCount">Mail</a></th>
    ...
    public function testInertiaPanelIsActiveAndRequestNavigationRetainsPanel(): void
    {
        ...
        self::assertSame(
            ...
            <a class="yii-debug-btn yii-debug-btn-ghost yii-debug-btn-icon" href="/debug/view?tag=request-2&amp;panel=inertia" title="Older request" aria-label="Older captured request">
            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="m6 9l6 6l6-6"/></g></svg>
            </a>
            <a class="yii-debug-btn yii-debug-btn-ghost yii-debug-btn-icon" href="/debug/view?tag=request-2&amp;panel=inertia" title="Oldest request" aria-label="Oldest captured request">
            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="m7 7l5 5l5-5"/><path d="m7 13l5 5l5-5"/></g></svg>
            </a>
            </div>
            </div>
    ...
    public function testProfilingPanelRendersUnifiedContentAndCanonicalNavigation(): void
    {
        $manifest = $this->manifest();
        ...
        self::assertStringContainsString(
            '<html lang="en" data-yii-debug-theme="dark">',
            $html,
            'The Profiling page must preserve the selected theme.',
        );
        self::assertStringContainsString(
            '<title>Profiling — Yii Debugger</title>',
            $html,
            'The merged page must retain the Profiling document title.',
        );
        self::assertStringContainsString(
            'title="View Profiling panel" aria-current="page"',
            $sidebar,
            'Profiling must remain the single active performance navigation item.',
        );
        self::assertStringNotContainsString(
            'View Timeline panel',
            $sidebar,
            'Timeline must not duplicate Profiling in the sidebar.',
        );
        self::assertStringNotContainsString(
            'aria-label="Profiling views"',
            $html,
            'The unified detail page must not retain a representation switcher.',
        );
        self::assertStringNotContainsString(
            'class="yii-debug-tabs"',
            $html,
            'The unified detail page must not render redundant tabs.',
        );
        self::assertStringContainsString(
            '<section class="yii-debug-tl">',
            $html,
            'The Timeline overview must render in the Profiling page.',
        );
        self::assertStringContainsString(
            'yii-debug-grid-profile',
            $html,
            'The detailed table must render below the Timeline overview.',
        );
        self::assertStringContainsString(
            '<h2>' . "\n" . 'Details',
            $html,
            'The unified page must use the concise details heading.',
        );
        self::assertStringNotContainsString(
            'profile blocks',
            $html,
            'The unified page must use span terminology consistently.',
        );
        self::assertStringContainsString(
            'name="Profile[duration]" type="number" value="20" min="0"',
            $html,
            'The shared duration filter must receive the current query value.',
        );
        self::assertStringContainsString(
            'name="Profile[category]" type="text" value="HomeAction"',
            $html,
            'The shared category filter must receive the current query value.',
        );
        self::assertStringContainsString(
            'name="Profile[info]" type="text" value="Build"',
            $html,
            'The shared info filter must receive the current query value.',
        );
        self::assertStringContainsString(
            'yii-debug-tl-row-other',
            $html,
            'The Timeline must compose the same filtered profile row as the table.',
        );
        self::assertStringContainsString(
            'yii-debug-tl-memory-gradient',
            $html,
            'The unified Timeline must compose the captured memory samples.',
        );
        self::assertStringContainsString(
            'action="/debug/view?tag=request-1&amp;panel=profiling"',
            $html,
            'Shared filtering must remain in the Profiling panel.',
        );
        self::assertStringNotContainsString(
            'name="view"',
            $html,
            'The shared form must not preserve the removed view state.',
        );
        self::assertStringNotContainsString(
            'name="Timeline[',
            $html,
            'The shared form must not emit the obsolete Timeline filter namespace.',
        );
        self::assertStringContainsString(
            'href="/debug/view?tag=request-2&amp;panel=profiling" title="Older request"',
            $sidebar,
            'Request navigation must target the canonical unified Profiling page.',
        );
        self::assertStringContainsString(
            'href="/debug/view?tag=request-1&amp;panel=profiling" '
                . 'title="View Profiling panel" aria-current="page"',
            $sidebar,
            'The active navigation item must target the canonical unified Profiling page.',
        );
        self::assertStringNotContainsString(
            'view=timeline',
            $html,
            'Legacy view state must be accepted but never re-emitted.',
        );
    }
     ...
     */
    private function rendererWithPanels(
