...
- fix(ui): unify Profiling filters and terminology, shorten Timeline labels with full hover text, align chart colors, and preserve request-scoped timing and post-flush spans.
